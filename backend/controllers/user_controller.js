...
import getDataUri from "../Connections/Datauri.js";
...
export const register = async (req, res) => {
    try {
        ...
        //Cloudinary for file(Profile photo)
        const file = req.file;
...
export const login = async (req, res) => {
    try {
        ...
        if (!isPasswordMatch) {
            return res.status(400).json({
                message: "Password doesn't match with above email.",
                success: false,
            })
        }
...
export const updateProfile = async (req, res) => {
    try {
        ...
        // let cloudResponse ;
                ...
                // resource_type:'raw' //Specify resource type for PDF's
